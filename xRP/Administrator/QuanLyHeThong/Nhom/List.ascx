<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="List.ascx.cs" Inherits="xRP.Administrator.QuanLyHeThong.Nhom.List" %>
...
<script type="text/javascript">
    function deleteItem(id) {
        ...
        $.ajax({
            type: "POST",
            url: "<%=Util.SERVER_NAME %><%=RootPageUrl%>Default.aspx/DeleteGroupItem",
            data: "{\"itemID\":'" + id + "'}",
    ...
    function doSearch() {
        ...
        var url = "";
        if (key.length == 0) {
            url = "Default.aspx?page=group";
        } else {
            url = "Default.aspx?page=group" + "&s=" + key;
        }
...
<script type="text/javascript">
    function OpenModal(id, text) {
        LoadUserControl("<%=Util.SERVER_NAME %>/Default.aspx", "/Administrator/QuanLyHeThong/Nhom/AddOrEdit.ascx", "&id=" + id);
        ...
        <div class="right-hub-content">
            <div class="work-item-form" style="display: block;">
                <div class="workitem-info-bar">
                    <div class="info-text-wrapper"><span class="info-text">Danh sách nhóm</span></div>
                </div>
                <div class="toolbar workitem-tool-bar" style="display: block;">
                    <ul class="menu-bar">
                        <li class="menu-item icon-only" id="btn-tinh-chat-xuat-nhap">
                            <a href="default.aspx?page=addgroup"><span class="icon icon-add"></span><span class="text">Thêm nhóm</span></a>
                        </li>
                            ...
                            <asp:Repeater ID="rptData" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="center-col"><a class="edit-icon" id="edit-icon" href="default.aspx?page=editgroup&id=<%# Eval("ID")%>"></a>
