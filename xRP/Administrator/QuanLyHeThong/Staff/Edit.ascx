<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Edit.ascx.cs" Inherits="xRP.Administrator.QuanLyHeThong.Staff.Edit" %>
            ...
            <div class="right-hub-content">
                <div class="work-item-form" style="display: block;">
                    <div class="workitem-info-bar">
                        <div class="info-text-wrapper"><span class="info-text"><%= GroupName %></span></div>
                    </div>
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <tr class="permission-row permission-not-editable data-item">
                                                                                ...
                                                                                <td class="permission-value-column accessible" tabindex="0">
                                                                                    <asp:CheckBox runat="server" ID="chkAdd" Checked='<%# Eval("IsGrant") %>' />
                                                                                </td>
                                                                            </tr>
                                                                        </ItemTemplate>
                                                                    </asp:Repeater>
