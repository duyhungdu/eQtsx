<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="List.ascx.cs" Inherits="xRP.Administrator.QuanLyHeThong.Staff.List" %>
...
<script type="text/javascript">
    ...
    function doSearch() {
        ...
        var url = "";
        if (key.length == 0) {
            url = "Default.aspx?page=staff";
        } else {
            url = "Default.aspx?page=staff" + "&s=" + key;
        }
    ...
    function editstaff(id) {
        ...
        if ($.QueryString("trang") != null) {
            ...
            page = 1;
        window.location.href = 'default.aspx?page=editstaff&id=' + id + "&trang=" + page;
    }
</script>
        ...
        <div class="right-hub-content">
            <div class="work-item-form" style="display: block;">
                <div class="workitem-info-bar">
                    <div class="info-text-wrapper"><span class="info-text">Danh sách cán bộ</span></div>
                </div>
                <div class="toolbar workitem-tool-bar" style="display: block;">
                    <ul class="menu-bar">
                        <li class="menu-item icon-only" id="btn-tinh-chat-xuat-nhap">
                            <a href="default.aspx?page=addstaff"><span class="icon icon-add"></span><span class="text">Thêm cán bộ</span></a>
                        </li>
                        ...
                        <li class="menu-item right-align icon-only">
                            <div class="search-adapter-work-items header-search search-box">
                                ...
                                <asp:TextBox ID="txtTimKiem" runat="server" Width="350px" placeholder="Tìm kiếm theo tên hoặc tài khoản" CssClass="box-search-in-form"></asp:TextBox>
                            ...
                            <asp:Repeater ID="rptData" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="center-col"><a class="edit-icon" id="edit-icon" href="javascript:editstaff('<%#Eval("ID") %>');"></a>
