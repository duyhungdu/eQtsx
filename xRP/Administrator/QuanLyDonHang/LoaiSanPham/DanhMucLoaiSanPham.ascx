<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhMucLoaiSanPham.ascx.cs" Inherits="xRP.Administrator.QuanLyDonHang.LoaiSanPham.DanhMucLoaiSanPham" %>
<%@ Register Assembly="CollectionPager" Namespace="SiteUtils" TagPrefix="cc1" %>
<script type="text/javascript">
    function OpenModal(id) {
        //var paging = $.QueryString("trang");
        //if (paging != null) {
        //LoadUserControl("<%=Util.SERVER_NAME %>/Default.aspx", "/Administrator/QuanLyDonHang/LoaiSanPham/AddOrEditLoaiSanPham.ascx", "&id=" + id + "&trang=" + paging);
        //}
        //else {
    ...
    function xoa(id) {
        ...
        if (answer) {
            ...
            $.ajax({
                type: "POST",
                url: "<%#Util.SERVER_NAME %>/Administrator/QuanLyDonHang/LoaiSanPham/DanhSachLoaiSanPham.aspx/XoaLoaiSanPham",
                data: "{id:" + id + "}",
        ...
        <div class="right-hub-content">
            <div class="work-item-form" style="display: block;">
                <div class="workitem-info-bar">
                    <div class="info-text-wrapper"><span class="info-text">Danh sách loại sản phẩm</span></div>
                </div>
                <div class="toolbar workitem-tool-bar" style="display: block;">
                    <ul class="menu-bar">

                        <li class="menu-item icon-only" id="btn-tao-moi-khach-hang" onclick="OpenModal(-1);"><span class="icon icon-add"></span><a href="javascript:void(0);">Tạo mới loại sản phẩm</a></li>
...
<div id="content_div" title="Cập nhật danh mục loại sản phẩm">
</div>
