<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhMucHeSoTongGiao.ascx.cs" Inherits="xRP.Administrator.QuanLyDonHang.HeSoTongGiao.DanhMucHeSoTongGiao" %>
<%@ Register Assembly="CollectionPager" Namespace="SiteUtils" TagPrefix="cc1" %>
<script type="text/javascript">
    function OpenModal(id) {
        //var paging = $.QueryString("trang");
        //if (paging != null) {
        //LoadUserControl("<%=Util.SERVER_NAME %>/Default.aspx", "/Administrator/QuanLyDonHang/HeSoTongGiao/AddorEditHeSoTongGiao.ascx", "&id=" + id + "&trang=" + paging);
        //}
        //else {
        LoadUserControl("<%=Util.SERVER_NAME %>/Default.aspx", "/Administrator/QuanLyDonHang/HeSoTongGiao/AddorEditHeSoTongGiao.ascx", "&id=" + id);
        //}
    ...
    function xoa(id) {
        ...
        if (answer) {
            ...
            $.ajax({
                type: "POST",
                url: "<%#Util.SERVER_NAME %>/Administrator/QuanLyDonHang/Default.aspx/XoaHeSoTongGiao",
                data: "{id:" + id + "}",
        ...
        <div class="right-hub-content">
            <div class="work-item-form" style="display: block;">
                <div class="workitem-info-bar">
                    <div class="info-text-wrapper"><span class="info-text">Danh sách hệ số tổng giao</span></div>
                </div>
                <div class="toolbar workitem-tool-bar" style="display: block;">
                    <ul class="menu-bar">

                        <li class="menu-item icon-only" id="btn-tao-moi-he-so-tonggiao" onclick="OpenModal(-1);"><span class="icon icon-add"></span><a href="javascript:void(0);">Tạo mới hệ số tổng giao</a></li>
                            ...
                            <asp:Repeater ID="rptDanhMucHeSoTongGiao" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="center-col"><%# Eval("HeSoTongDao") %></td>
...
<div id="content_div" title="Cập nhật danh mục hệ số tổng giao">
</div>
