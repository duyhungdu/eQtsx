<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhMucPhieuKiemTraVatTuXuat.ascx.cs" Inherits="xRP.Business.QuanLyVatTu.XuatVatTu.DanhMucPhieuKiemTraVatTuXuat" %>
        ...
        <div class="right-hub-content">
            <div class="work-item-form" style="display: block;">
                <div class="workitem-info-bar">
                    <div class="info-text-wrapper"><span class="info-text">Danh sách phiếu xuất vật tư</span></div>
                </div>
