...
{
    public partial class XtraReportNhapXuatTonTheoChitTietVatTuNCC : DevExpress.XtraReports.UI.XtraReport
    {
        public XtraReportNhapXuatTonTheoChitTietVatTuNCC(string lsKhoId, string lsLoaiVatTuId, string lsVatTuId, string lsNhaCungCapId, DateTime? ngayBatDau, DateTime? ngayKetThuc, bool truloi)
        {
            InitializeComponent();
