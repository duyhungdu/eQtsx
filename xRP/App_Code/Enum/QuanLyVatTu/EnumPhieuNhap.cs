...
namespace xRP
{
    class EnumPhieuNhap
    {
        ...
        /// </summary>
        public enum SelectTypes { All = 0, ByID = 1, ByNhaCungCapID = 2, ByKhoVatTuID = 3, ByCreatedDate = 4, ByTinhChatNhapXuatID = 5, Seach = -1 }

        /// <summary>
        /// LoaiVatTu
        /// </summary>
        public enum KieuVatTu { All = 0, VatTuNhap = 1, NhapThanhPham = 2 }
    }
}
